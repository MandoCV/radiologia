...
/* IMPORTACIONES VIEWS */
import crudRadio from '../views/Radio/Crud.vue'
import tablaRadio from '../views/Radio/Tabla.vue'
import dashRadio from '../views/Radio/Dash.vue'
...
const radioChildRoutes = (prop, mode = false) => [
  {
    path: 'Crud',
    name: prop + '.Crud',
    meta: { dark: mode, auth: true },
...
const routes = [
  {
    ...
    component: Layout1,
    meta: { auth: true },
    children: radioChildRoutes('Radio')
  },
  {
    path: '/',
    name: 'dashboard',
